...
class Bridge(object):
    ...
    def publish_camera(self, data):
        ...
        # image.save("/capstone/car_images/car_%08d.jpg" % self.counter, "JPEG", quality=100, optimize=True, progressive=True)
        self.counter += 1
        image_array = np.asarray(image)

        ##rospy.logwarn('{}, {}, {}'.format(type(image_array), image_array.shape, image_array))
